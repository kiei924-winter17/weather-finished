$(function() {
  var handleWeatherResponse = function(weather) {
    ...
    var markup = "The current temperature is "
    markup = markup + weather.currently.temperature
    markup = markup + "... and tomorrow it will be "
    markup = markup + weather.daily.data[1].summary
    markup = markup + "... and the next day it will be "
    markup = markup + weather.daily.data[2].summary
